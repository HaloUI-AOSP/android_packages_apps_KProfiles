...
#+BEGIN_SRC shell
git clone https://github.com/HaloUI-AOSP/android_packages_apps_KProfiles.git packages/apps/KProfiles 
#+END_SRC

** 2) Pick the following change in your device tree and build it as it is :)
https://github.com/HaloUI-Devices/android_device_xiaomi_onyx/commit/6d6cd1d249a4c323908344659071de90edfaf420
